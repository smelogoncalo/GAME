...
im = plt.imread("Carnage.bmp")
arr = np.random.rand(32,32)
arr=np.uint8(arr)
im1 = plt.imread("Dr Octopus.bmp")
arr1 = np.random.rand(32,32)
arr1=np.uint8(arr1)
im2 = plt.imread("Green Goblin.bmp")
arr2 = np.random.rand(32,32)
arr2=np.uint8(arr2)
im3 = plt.imread("Hobgoblin.bmp")
arr3 = np.random.rand(32,32)
arr3=np.uint8(arr3)
im4 = plt.imread("Kraven.bmp")
arr4 = np.random.rand(32,32)
arr4=np.uint8(arr4)
im5 = plt.imread("Lizard.bmp")
arr5 = np.random.rand(32,32)
arr5=np.uint8(arr5)
im6 = plt.imread("Vulture.bmp")
arr6 = np.random.rand(32,32)
arr6=np.uint8(arr6)
im7 = plt.imread("Mysterio1.bmp")
arr7 = np.random.rand(32,32)
arr7=np.uint8(arr7)
im8 = plt.imread("Shocker.bmp")
arr8 = np.random.rand(32,32)
arr8=np.uint8(arr8)
im9 = plt.imread("Venom.bmp")
...
for r in range (32):
    for c in range (32):
        ...
        byte1=0          
    r=r+1
with open('bmp_arr.txt','w') as fp:
    fp.write("unsigned char ICON00[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=hex(arr[r][c])
...
for r in range (32):
    for c in range (32):
        ...
        byte1=0          
    r=r+1
with open('bmp_arr.txt','a') as fp:
    fp.write("unsigned char ICON01[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=hex(arr1[r][c])
...
for r in range (32):
    ...
    r=r+1
with open('bmp_arr.txt','a') as fp:
    fp.write("unsigned char ICON02[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=hex(arr2[r][c])
...
for r in range (32):
    ...
    r=r+1
with open('bmp_arr.txt','a') as fp:
    fp.write("unsigned char ICON03[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=hex(arr3[r][c])
...
for r in range (32):
    ...
    r=r+1
with open('bmp_arr.txt','a') as fp:
    fp.write("unsigned char ICON04[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=hex(arr4[r][c])
...
for r in range (32):
    ...
    r=r+1
with open('bmp_arr.txt','a') as fp:
    fp.write("unsigned char ICON05[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=hex(arr5[r][c])
...
for r in range (32):
    ...
    r=r+1
with open('bmp_arr.txt','a') as fp:
    fp.write("unsigned char ICON06[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=hex(arr6[r][c])
...
for r in range (32):
    ...
    r=r+1
with open('bmp_arr.txt','a') as fp:
    fp.write("unsigned char ICON07[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=hex(arr7[r][c])
...
for r in range (32):
    ...
    r=r+1
with open('bmp_arr.txt','a') as fp:
    fp.write("unsigned char ICON08[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=hex(arr8[r][c])
...
for r in range (32):
    ...
    r=r+1
with open('bmp_arr.txt','a') as fp:
    fp.write("unsigned char ICON09[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=hex(arr9[r][c])
